...
-- ============================================================
-- MIGRACIONES — Desvincular vehículo de un cliente
-- ============================================================

-- Permite al dueño desvincular un vehículo de un cliente (no borra el
-- vehículo, solo la relación cliente-vehículo)
